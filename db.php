...
$AdidasCollar = new Clothing("collar", "adidas", 20, $cat, "https://www.adidas.fr/dis/dw/image/v2/aagl_prd/on/demandware.static/-/Sites-adidas-products/default/dw7b3b3b3b/zoom/DT7159_21_model.jpg?sh=840", "leather");
$SnackSalmon = new Food("snack salmon", "purina", 5, $cat, "https://www.purina.fr/sites/g/files/auxxlc391/files/styles/product/public/2020-01/ProPlan_Snack_Saumon_0.png?itok=3Z9Z9Z9Z", "dry");
$MouseToy = new Toy("mouse", "kong", 10, $cat, "https://www.kongcompany.com/wp-content/uploads/2019/12/Classic-Dog-Toy-Red-1.png", "plastic");


var_dump($Salopette);
var_dump($SnackBeef);
var_dump($AnanasToy);
var_dump($AdidasCollar);
var_dump($SnackSalmon);
var_dump($MouseToy);
